        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Course_DurationHours", "[DurationHours] > 0");
                    table.CheckConstraint("CK_Course_TuitionFee", "[TuitionFee] >= 0");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Class_Dates", "[EndDate] > [StartDate]");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Score_Value", "[ScoreValue] >= 0 AND [ScoreValue] <= 10");
                    table.ForeignKey(
